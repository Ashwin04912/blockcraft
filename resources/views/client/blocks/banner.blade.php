@php
    ...
    $overlayCss = match($bgStyle) {
        'dark'     => 'linear-gradient(to top, rgba(2, 6, 23, 0.85), rgba(2, 6, 23, 0.2), transparent)',
        'gradient' => 'linear-gradient(to top, rgba(79, 70, 229, 0.85), rgba(124, 58, 237, 0.35), transparent)',
        default    => 'linear-gradient(to top, rgba(2, 6, 23, 0.6), rgba(2, 6, 23, 0.1), transparent)',
    };
@endphp
